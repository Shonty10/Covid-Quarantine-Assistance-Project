...
##weight
wt=tk.Label(page2,fg="black",text="Enter Weight (Kgs):",bg="white",font="Verdana 10 bold italic",).place(x=660,y=200)
wt_e=tk.Entry(page2,width=21,font="Verdana 9 bold italic",relief="sunken",borderwidth=3)
wt_e.place(x=1000,y=200)
##bloodpressure
bp=tk.Label(page2,fg="black",text="Enter Blood Pressure (mm Hg):",bg="white",font="Verdana 10 bold italic",).place(x=660,y=300)
bpp=tk.Label(page2,fg="black",text="(Systolic/Diastolic)",bg="white",font="Verdana 10 bold italic",).place(x=660,y=330)
bp_e=tk.Entry(page2,width=21,font="Verdana 9 bold italic",relief="sunken",borderwidth=3)
bp_e.place(x=1000,y=300)
##heartrate
hr=tk.Label(page2,fg="black",text="Enter Heart Rate(Bpm):",bg="white",font="Verdana 10 bold italic",).place(x=660,y=250)
...
'''myclose_but1=Image.open("C:/Users/Siddharth Reddy/Desktop/Comp Investigatory/Comp Project-20201230T195246Z-001/Comp Project/close_red.png")
resizeclose=myclose_but1.resize((120,47),Image.ANTIALIAS)
ne442=ImageTk.PhotoImage(resizeclose)

close_but1=tk.Button(page2,bg="white",image=ne442,command=root.destroy,borderwidth=0)
close_but1.place(x=900,y=660)'''
