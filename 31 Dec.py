...
def login():
    ...
    if username_check()==True:
        mycursor.execute("select pwd from users where username =  '" + t1 + "' ") ##gives form 't2'
...
username_e=tk.Entry(page1,width=28,font="Verdana 9  italic",bg="white",borderwidth=3)
...
ph_e=tk.Entry(page1,width=28,font="Verdana 9  italic",bg="white",borderwidth=3)
ph_e.place(x=350,y=165)
#email
email=tk.Label(page1,fg="black",text=" EMAIL ID :",bg="white",font="Verdana 10 bold italic").place(x=60,y=205)
email_e=tk.Entry(page1,width=28,font="Verdana 9  italic",bg="white",borderwidth=3)
...
md_e=tk.Entry(page1,width=28,font="Verdana 9  italic",bg="white",borderwidth=3)
...
allr_e=tk.Entry(page1,width=18,font="Verdana 13  italic",bg="white",borderwidth=3)
...
sptr_e=tk.Entry(page1,width=18,font="Verdana 13  italic",bg="white",borderwidth=3)
...
def account_created():
    acc_created=tk.Label(page1,text='created!',fg="black",bg="white",font="Verdana 10 bold italic")
    acc_created.place(x=900,y=500)
