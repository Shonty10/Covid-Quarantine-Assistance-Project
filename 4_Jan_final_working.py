...
def validate():
    ...
    if n1.isalpha()==False or n10.isalpha()==False or n12.isalpha()==False or n14.isalpha()==False : #if all(n1.isalpha() or n1.isspace() for x in n1):
    ...
    if h14!="" or h15!="" or h16!="" or h17!="":
        ...
        if h18==5:
            ...
            if (avg_d5<=35):
                ...
                b=[]
                data=[]
                mycursor.execute("select name, email, pricon1_email, pricon2_email, pricon3_email from users where username='" + t1 + "' ") ##gives form 't1'
                tab2=mycursor.fetchall()
                for z in tab2:
                    b.append(z)
                for i in z:
                ...
                for i in email:
                    ...
                    #l=["Thank you for entering your data!","Please come back tomorrow.","You may close the application."]
                    #messagebox.showinfo('Covid Quarantine Assisstance',"\n".join(l))
                    body = "Dear Sir/ma'am\n\nPlease find attached a copy of Mr/Mrs "+str(n1)+ "'s COVID Quarantine assistance program health stats report.\nThe users health has not been looking for the past few days.\n\nThank you for using our programme\nRegards\nCQAP team"
                    msg.attach(MIMEText(body, 'plain'))
                ...
                b=[]
                data=[]
                mycursor.execute("select name, email from users where username='" + t1 + "' ") ##gives form 't1'
                tab2=mycursor.fetchall()
                for z in tab2:
                    b.append(z)
                for i in z:
