...
##bloodpressure
bp=tk.Label(page2,fg="black",text="Enter Blood Pressure (mm Hg):",bg="white",font="Verdana 10 bold italic",).place(x=660,y=210)
bpp=tk.Label(page2,fg="black",text="(Systolic/Diastolic)",bg="white",font="Verdana 10 bold italic",).place(x=660,y=225)
